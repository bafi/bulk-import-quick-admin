...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.properties.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="image">{{ trans('cruds.property.fields.image') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.property.fields.image_helper') }}</span>
            </div>
            <div class="form-group">
...
@if(isset($property) && $property->image)
      var file = {!! json_encode($property->image) !!}
